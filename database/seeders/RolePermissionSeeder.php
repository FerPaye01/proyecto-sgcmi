...
class RolePermissionSeeder extends Seeder
{
    public function run(): void
    {
        $permissions = [
            ...
            'PORT_REPORT_READ', 'PORT_REPORT_WRITE', 'ROAD_REPORT_READ', 'CUS_REPORT_READ',
        ...
        $roles = [
            'ADMIN' => ['*'],
            'PLANIFICADOR_PUERTO' => ['SCHEDULE_READ', 'SCHEDULE_WRITE', 'PORT_REPORT_READ', 'PORT_REPORT_WRITE', 'REPORT_READ', 'REPORT_EXPORT'],
            'OPERACIONES_PUERTO' => ['PORT_REPORT_READ', 'PORT_REPORT_WRITE', 'ROAD_REPORT_READ', 'REPORT_READ'],
