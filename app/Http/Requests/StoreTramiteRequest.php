...
class StoreTramiteRequest extends FormRequest
{
    ...
    {
        return [
            'tramite_ext_id' => ['required', 'string', 'max:50', 'unique:App\Models\Tramite,tramite_ext_id'],
            'vessel_call_id' => ['required', 'integer', 'exists:App\Models\VesselCall,id'],
            'regimen' => ['required', 'string', 'in:IMPORTACION,EXPORTACION,TRANSITO'],
            ...
            'entidad_id' => ['required', 'integer', 'exists:App\Models\Entidad,id'],
        ];
    }
